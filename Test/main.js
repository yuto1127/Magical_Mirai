...
*/
text_li.push(new FadeInClass("こちらは","20px","#000000","200px","100px",1000,1000,1000));//フェードインするテキストを配列に追加
text_li.push(new FadeInClass("テスト","20px","#000000","200px","150px",1000,1000,1000));
text_li.push(new FadeInClass("でした","20px","#000000","200px","200px",1000,1000,1000));
