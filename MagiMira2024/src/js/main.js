...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const bg_9$1 = bg_pass + "";
    const bg_9$2 = bg_pass + "";
    const bg_9$3 = bg_pass + "";
    const bg_9$4 = bg_pass + "";
    const bg_11$1 = bg_pass + "";
    const bg_11$2 = bg_pass + "";
    const bg_11$3 = bg_pass + "";
    const bg_11$4 = bg_pass + "";
    const bg_14 = bg_pass + "";
    const bg_15_20 = bg_pass + "";
